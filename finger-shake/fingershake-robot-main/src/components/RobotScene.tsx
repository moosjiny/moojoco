    ...
    const renderLoop = () => {
      ...
      if (alpha && beta) {
        ...
        if (mode === 'rl_agent') {
          ...
          alpha.head.rotation.x = manualAnglesAlpha.headPitch * degToRad;
          ...
          alpha.leftHip.rotation.x = manualAnglesAlpha.hipFlexion * degToRad;
          alpha.rightHip.rotation.x = manualAnglesAlpha.hipFlexion * degToRad;
          alpha.leftKnee.rotation.x = manualAnglesAlpha.kneeFlexion * degToRad;
          alpha.rightKnee.rotation.x = manualAnglesAlpha.kneeFlexion * degToRad;
          ...
          beta.head.rotation.x = manualAnglesBeta.headPitch * degToRad;
          ...
          beta.leftHip.rotation.x = manualAnglesBeta.hipFlexion * degToRad;
          beta.rightHip.rotation.x = manualAnglesBeta.hipFlexion * degToRad;
          beta.leftKnee.rotation.x = manualAnglesBeta.kneeFlexion * degToRad;
          beta.rightKnee.rotation.x = manualAnglesBeta.kneeFlexion * degToRad;
