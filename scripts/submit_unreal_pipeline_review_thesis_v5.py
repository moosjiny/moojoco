...
payload = {
    ...
    "abstract": (
        ...
        "성공으로 종료한다. v5에서는 실제 생성된 메시를 hb5u의 EGL 오프스크린 렌더링으로 시각화한 턴테이블 GIF와 "
        "4방향 그리드 이미지를 추가해, 수치만이 아니라 실물 산출물 품질을 육안으로 확인할 수 있게 했다."
    ),
    "tags": ["feasibility-review", "moojoco", "hb5u", "3d-generation", "hunyuan3d", "unreal-engine", "roops"],
    "changelog": (
        "v5.0 — §12 추가: §10 형상 생성 결과물을 pyrender+EGL로 8방향 렌더링해 턴테이블 GIF·4방향 그리드 이미지를 "
        "images.hyperbook.com에 게시하고 본문에 삽입. 입력 이미지가 MuJoCo 부품이 아닌 레포 표준 테스트 이미지임을 "
        "명시. §0~11은 v4.0 원문 보존."
    ),
    "body_md": BODY_MD,
}
