...
payload = {
    ...
    "abstract": (
        ...
        "수렴하는 것을 실측 확인했다 — 1단계 정적 판정만으로는 포착할 수 없는 사례로, 2단계의 필요성을 그대로 "
        "보여줬다. 여전히 진짜 물리 솔버가 아닌 사후 진단 도구라는 한계를 남겼고, 계획 문서의 3단계(옵션 A/B)는 "
        "아키텍처 결정이 필요해 보류했다."
    ),
    "tags": ["handshake-robot", "physics", "kinematics", "moojoco", "result"],
    "changelog": "v1.0 — 최초 제출: 2단계(동적 ZMP+마찰원뿔) 구현·실측·배포",
    "body_md": BODY_MD,
}
